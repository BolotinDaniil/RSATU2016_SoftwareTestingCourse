...
На данном этапе было обнаружено, что что-то пошло не так.
...
\begin{table}[h!]
	\caption{Прохождение автоматиированных GUI тестов при интеграционном тестировании (не полностью заполнено)}
	\centering
	\begin{tabular}{|c|l|l|}
	\hline 
	№ &  Название теста & Результат \\ 
	...
	\hline 
	5 & integrationCipherEqualsTest & \textbf{Не пройден}  \\
	\hline
\end{tabular} 
